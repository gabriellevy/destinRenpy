...
label univTempliers_evt4:
    ...
    $ AjouterACarac(metier.Chevalier.NOM, 2)
    jump fin_cycle
...
label univTempliers_evt6:
    ...
    $ AjouterACarac(metier.Architecte.NOM, 2)
    jump fin_cycle
...
label univTempliers_evt7:
    ...
    $ AjouterACarac(metier.Banquier.NOM, 2)
    jump fin_cycle
...
label univTempliers_evt9:
    ...
    $ AjouterACarac(metier.TueurDeMonstres.NOM, 1)
    $ resProba = random.uniform(0, 1.0)
    if resProba < 0.4:
...
label univTempliers_evt12:
    ...
    if religionActuelle != religion.Christianisme.NOM:
        ...
        if conversion:
            "Vous vous convertissez au christianisme."
            $ AjouterACarac(religion.Religion.C_FOI,  1)
...
label univTempliers_evt13:
    ...
    $ AjouterACarac(metier.Dessinateur.NOM, 1)
