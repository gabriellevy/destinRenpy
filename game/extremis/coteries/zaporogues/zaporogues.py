...
class Zaporogues(coterie.Coterie):

    NOM = u"Zaporogues"
    ID = u"zaporogues"

    def __init__(self):
        self.nom_ = Zaporogues.NOM
        self.id_ = Zaporogues.ID
        # self.quartier_ = quartier.SaintDenis.NOM

    def getLabelUniversite(self):
        return "univZaporogues"
    ...
    def CreerNom(self, masculin):
        ...
        """
        return random.choice(Zaporogues.NOMS)
    ...
    def CreerPrenom(self, masculin):
        ...
        """
        if masculin:
            return random.choice(Zaporogues.PRENOMS_M)
        else:
            return random.choice(Zaporogues.PRENOMS_F)
